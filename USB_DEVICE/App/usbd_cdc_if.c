...
uint8_t uart_rxBuf[CDC_NO_OF_CLASS][256];
uint8_t uart_txBuf[CDC_NO_OF_CLASS][256];

RingBuffer uart_rb_rx[CDC_NO_OF_CLASS];
RingBuffer uart_rb_tx[CDC_NO_OF_CLASS];

UartState uartState[CDC_NO_OF_CLASS];

//volatile uint8_t transmit_flag[CDC_NO_OF_CLASS];
